...
//    No hooks here (so early return is safe). Clamps position to viewport. */
...
//   // Clamp preview so it stays on screen
//   const vw = typeof window !== "undefined" ? window.innerWidth : 1920;
//   const vh = typeof window !== "undefined" ? window.innerHeight : 1080;
//   const rawLeft = position.x + OFFSET;
//   const rawTop = position.y + OFFSET;
//   const left = Math.min(rawLeft, vw - PREVIEW_W - 8);
//   const top = Math.min(rawTop, vh - PREVIEW_H - 8);
...
// /* ─────────────────────────────────── Page ───────────────────────────────────
//    Expand rows on click; large hover overlay on desktop. */
...
//         <div>
//           <h1 className="text-6xl font-extrabold">concept_for_scroll_row</h1>
//         </div>
